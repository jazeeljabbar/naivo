...
class Theme_My_Login_Custom_Passwords extends Theme_My_Login_Abstract {
	...
	public function password_fields() {
		...
		<p class="tml-user-pass1-wrap">
			<input autocomplete="off" name="pass1" id="pass1<?php $template->the_instance(); ?>" placeholder="Password" class="input" size="20" value="" type="password" />
		</p>
		<p class="tml-user-pass2-wrap">
			<input autocomplete="off" name="pass2" id="pass2<?php $template->the_instance(); ?>" placeholder="Confirm Password" class="input" size="20" value="" type="password" />
		</p>
		<?php
	}
