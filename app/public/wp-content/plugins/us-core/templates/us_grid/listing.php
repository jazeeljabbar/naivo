...
$us_grid_no_items_message = isset( $no_items_message ) ? $no_items_message : /* Default */us_translate( 'No results found.' );
$us_grid_no_items_action = isset( $no_items_action ) ? $no_items_action : /* Default */'message';
