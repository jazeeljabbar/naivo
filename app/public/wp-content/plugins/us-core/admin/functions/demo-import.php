					...
					<div class="w-importer-item-options-h">
						...
						<?php if ( in_array( 'content_templates', $import['content'] ) ) { ?>
							<label class="usof-checkbox child">
								...
								<span class="usof-checkbox-text"><?php echo __( 'Page Templates', 'us' ) ?></span>
							</label>
						<?php } ?>
						<?php if ( in_array( 'page_blocks', $import['content'] ) ) { ?>
							<label class="usof-checkbox child">
								...
								<span class="usof-checkbox-text"><?php echo __( 'Reusable Blocks', 'us' ) ?></span>
							</label>
						<?php } ?>
...
function us_demo_import_content_page_blocks() {
	us_action_for_demo_import( 'page_blocks', __( 'Reusable Blocks', 'us' ) );
}
...
function us_demo_import_content_content_templates() {
	us_action_for_demo_import( 'content_templates', __( 'Page Templates', 'us' ) );
}
