...
return array(
	...
	// Preload the fieldset for the Live Builder, if not set, settings will be loaded via AJAX
	'usb_preload' => TRUE,
	...
	'params' => array(
		...
		'option_name' => array(
			...
			// Allows to override the config file of existing 3rd-party element. Used in BOTH builders
		...
		// By default, drag & drop movement occurs along vertical axis,
