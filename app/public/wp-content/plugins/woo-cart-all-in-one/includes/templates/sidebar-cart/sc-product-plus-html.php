...
?>
<div class="vi-wcaio-sidebar-cart-footer-pd vi-wcaio-sidebar-cart-footer-pd-type-1" data-product_id="<?php echo esc_attr( $product_id ); ?>" data-product_type="<?php echo esc_attr( $product->get_type() ); ?>">
