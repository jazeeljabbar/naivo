(function ($) {
    ...
    function viwcaio_sidebar_cart_update() {
        ...
        $(document.body).on('added_to_cart', function (evt, fragments, cart_hash, btn) {
            ...
            if (fly_to_cart) {
                let img_product = viwcaio_get_img_product(btn),
                    sc_icon = $('#sidecartOpenID').first();
                
                if (!sc_icon.length) {
                    sc_icon = $('.w-cart-link, .header_cart_link, .vi-wcaio-sidebar-cart-icon-wrap').first();
                }
                ...
                if ($(img_product).length && sc_icon.length) {
                    ...
                    img_flying.animate({
                        'width': (img_width * 0.5) + 'px',
                        'height': (img_height * 0.5) + 'px'
                    }, 400, 'swing', function () {
                        img_flying.animate({
                            top: sc_icon_top + 'px',
