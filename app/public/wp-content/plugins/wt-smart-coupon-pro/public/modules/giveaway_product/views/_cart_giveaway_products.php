...
<div class="wt_sc_giveaway_products_cart_page">
        ...
        foreach($free_products as $coupon_code=>$free_product_items)
        {
            ...
            $message=__('Congratulations! Choose your freebie from below:', 'wt-smart-coupons-for-woocommerce-pro');
            ...
            <ul class="woocommcerce wt_give_away_products" coupon="<?php echo esc_attr($coupon_id);?>">
                ...
                foreach($free_product_items as $product_id => $product_data)
                {
                    ...
                    ?>
                    <li class="wt_get_away_product" title="<?php echo esc_attr($_product->get_name()); ?>" data-is_purchasable="<?php echo esc_attr($is_purchasable ? 1 : 0); ?>" product-id="<?php echo esc_attr( $temp_product_id ); ?>">
                        <div class="wt_product_image">
                            ...
                            ?> 
                                <div class="wt_product_discount">
                                    ...
                                    ?>
                                        <div>
                                            <?php _e('Price: ', 'wt-smart-coupons-for-woocommerce-pro'); ?>
                                    ...
                                    ?>
                                    <div>
                                        <?php _e('Discount: ', 'wt-smart-coupons-for-woocommerce-pro'); ?> 
                                        <?php
                            ...
                            {
                                ?>
                                <p class="wt_sc_product_out_of_stock stock out-of-stock"><?php echo wp_kses_post($this->get_customized_text('non_purchasable_giveaway_varaition')); ?></p>
                                <?php
                            }
                            ?>                     
                        </div>
                            ...
                            if($is_purchasable)
                            {
                                ...
                                if( !empty( $default_attributes ) ){
                                    ...
                                    $default_variation_attributes = array_combine(
                                        array_map( function( $key ) { return 'attribute_' . $key; }, array_keys( $default_attributes ) ),
                                        $default_attributes
                                    );

                                    $default_variation_id = $this->find_matching_product_variation_id( $product_id, $default_variation_attributes );
                                }
                                ?>
                                ...
                                <input type="hidden" name="wt_variation_options" value="<?php echo esc_attr( json_encode( $default_variation_attributes ) ) ?>" />
                                <?php
                            }
                        }
                        ...
                        if( ( $single_add_to_cart || $variation_without_attributes ) && $is_purchasable ) 
                        {
                            ...
                            <div class="wt_choose_button_box">
                                ...
                                {
                                ?>
                                    <div class="wt_giveaway_quantity">
                                        <input type="number" name="wt_giveaway_quantity" min="1" step="1" max="<?php echo esc_attr($show_quantity_option[$coupon_id]);?>" value="<?php echo esc_attr($show_quantity_option[$coupon_id]);?>">
                                    </div>   
                                <?php 
                                }
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="value">
                                                            ...
                                                            <option value=""><?php esc_html_e( 'Choose an option', 'wt-smart-coupons-for-woocommerce-pro' ); ?></option>
                                                            <?php
                                ...
                                if( !$variation_without_attributes || $single_add_to_cart ){
                                    ?>
                                        <button class="wt_choose_free_product button" prod-id="<?php echo esc_attr($product_id); ?>" variation="<?php echo esc_attr($variation_id); ?>" type="button"><?php echo __('Choose Product','wt-smart-coupons-for-woocommerce-pro'); ?></button>
                                    <?php
                                }
                                ?>
                            </div>
            ...
            {
                $button_label=($total_purchasable>1 ? __('Add all to cart', 'wt-smart-coupons-for-woocommerce-pro') : __('Add to cart', 'wt-smart-coupons-for-woocommerce-pro'));
                ?>
                <div class="wt_add_to_cart_all">
                    <button class="wt_add_to_cart_all_btn" coupon-id="<?php echo esc_attr($coupon_id); ?>" type="button"><?php echo esc_html($button_label); ?></button>
                </div>
                <?php
            }
        }              
