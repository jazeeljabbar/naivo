    ...
    public function apply_url_coupon()
    {
        ...
        if(""!=$coupon_code && Wt_Smart_Coupon_Common::is_coupon_exists($coupon_code))
        {
            ...
            {              
                ...
                $new_message = apply_filters('wt_smart_coupon_url_coupon_message', $message);
            ...
            }else
            {
                ...
                $new_message    = sprintf(__('Oops your cart is empty! Add %sproducts%s to your cart to avail the offer.', 'wt-smart-coupons-for-woocommerce-pro'), '<a href="'.esc_attr($shop_page_url).'">', '</a>');
