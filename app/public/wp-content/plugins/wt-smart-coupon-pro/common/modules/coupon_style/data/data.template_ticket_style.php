...
.wt-single-coupon.ticket_style .wt_sc_coupon_type{font-weight:500;font-size:22px}
...
.wt_sc_single_coupon.ticket_style .wt_sc_coupon_start, .wt_sc_single_coupon.ticket_style .wt_sc_coupon_expiry{ width:100%; float:left;}
</style>

<div class="wt_sc_single_coupon wt-single-coupon ticket_style [wt_sc_single_coupon_class]" data-id="[wt_sc_coupon_id]" data-code="[wt_sc_coupon_code_attr]" title="[wt_sc_single_coupon_title]" style="background:[wt_sc_color_0]; border:1px dotted [wt_sc_color_1]; color:[wt_sc_color_2];">
