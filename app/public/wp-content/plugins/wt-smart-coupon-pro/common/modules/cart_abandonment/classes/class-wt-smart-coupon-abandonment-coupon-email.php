...
if( ! class_exists('WT_smart_Coupon_Abandonment_Coupon_Email' ))
{
	class WT_smart_Coupon_Abandonment_Coupon_Email extends WC_Email{
		...
		function __construct()
		{
			...
			$this->title          = __('Your favourites are running out of stock!', 'wt-smart-coupons-for-woocommerce-pro' );
			$this->description    = __('This email for sending abandonment coupon.', 'wt-smart-coupons-for-woocommerce-pro' );
			$this->customer_email = true;

			$this->heading        = __('Your favourites are running out of stock!', 'wt-smart-coupons-for-woocommerce-pro' );
			$this->subject        = sprintf(_x('Your favourites are running out of stock!', 'default email subject for active emails sent to the customer', 'wt-smart-coupons-for-woocommerce-pro') );
