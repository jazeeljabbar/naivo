...
if ( ! class_exists( 'Wt_Gdpr_Promotion_banner' ) ) {
    class Wt_Gdpr_Promotion_banner {
        ...
        private static $promotion_link = "https://www.webtoffee.com/product/gdpr-cookie-consent/?utm_source=free_plugin_smart_coupon&utm_medium=smart_coupon_premium&utm_campaign=GDPR"; // Update the promotion link depending on the plugin
        ...
        public function show_banner() {
            ...
            if ( $this->is_show_banner() && 'dashboard' === $current_screen->base ) {
            ?>
            <div class="wt-gdpr-promotion-banner notice notice-info is-dismissible">
                <div class="wt-gdpr-promotion-banner-header">
                    <p><?php esc_html_e( 'Get Cookie Consent With Google-Certified CMP for WordPress', 'wt-smart-coupons-for-woocommerce-pro' ); ?></p>
                </div>
                <div class="wt-gdpr-promotion-banner-body">
                    <p>
                        <?php 
                            echo sprintf(
                                esc_html__('Trusted by %1$s WordPress websites for cookie compliance with %2$s.', 'wt-smart-coupons-for-woocommerce-pro'),
                                '<span>' . esc_html__( '1 Million+', 'wt-smart-coupons-for-woocommerce-pro' ) . '</span>',
                                '<span>' . esc_html__( 'GPDF, CCPA', 'wt-smart-coupons-for-woocommerce-pro' ) . '</span>',
                                '<span>' . esc_html__( 'US State laws', 'wt-smart-coupons-for-woocommerce-pro' ) . '</span>'
                            );
                        ?>
                    </p>
                    <ul class="wt-gdpr-promotion-banner-highlights">
                        <li><?php esc_html_e( 'Cookie banner with Accept & Reject buttons', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                        <li><?php esc_html_e( 'Opt-in and opt-out consent', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                        <li><?php esc_html_e( 'Advanced cookie scanner', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                        <li><?php esc_html_e( 'Automatic script blocker', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                        <li><?php esc_html_e( 'Obtain granular consent for cookies', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                        <li><?php esc_html_e( 'Supports Google Consent Mode v2', 'wt-smart-coupons-for-woocommerce-pro' ); ?></li>
                    </ul>
                </div>
                <div class="wt-gdpr-promotion-banner-footer">
                    <a href="<?php echo esc_url( self::$promotion_link ); ?>" target="_blank" class="button button-primary product-page-btn"><?php esc_html_e( 'Get WP GDPR Cookie Consent', 'wt-smart-coupons-for-woocommerce-pro' ); ?></a>
                    <a class="button banner-dismiss-btn"><?php esc_html_e( 'Dismiss forever', 'wt-smart-coupons-for-woocommerce-pro' ); ?></a>
                </div>
            </div>
            <?php
            }
