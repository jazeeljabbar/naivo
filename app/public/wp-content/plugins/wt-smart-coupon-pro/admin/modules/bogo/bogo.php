 ...
 *
 * Create submenu for new BOGO, enqueue style style and javascript file for admin side.
 */
class Wbte_Smart_Coupon_Bogo_Admin extends Wbte_Smart_Coupon_Bogo_Common {
	...
	public function __construct() {
		...
		add_action( 'wbte_sc_after_coupon_imported', array( $this, 'make_old_bogo_draft_on_import' ), 10, 3 );
		...
		/* Giveaway details into order edit table */
	...
	public function add_admin_pages( $menus ) {
		$menus[] = array(
			'submenu',
			WT_SC_PLUGIN_NAME,
			__( 'BOGO', 'wt-smart-coupons-for-woocommerce-pro' ),
			__( 'BOGO', 'wt-smart-coupons-for-woocommerce-pro' ),
			'manage_woocommerce',
			$this->module_id,
	...
	public function bogo_page_content() {
		$admin_img_path = WT_SMARTCOUPON_URL . 'admin/images/';
			...
			wp_localize_script(
				...
				array(
					...
					'text'                    => array(
						...
						'selected'            => __( 'selected', 'wt-smart-coupons-for-woocommerce-pro' ),
						'email_placeholder'   => __( 'No restrictions', 'wt-smart-coupons-for-woocommerce-pro' ),
						'buys'                => __( 'Buy', 'wt-smart-coupons-for-woocommerce-pro' ),
						'spends'              => __( 'Spend', 'wt-smart-coupons-for-woocommerce-pro' ),
						'currency_symbol'     => get_woocommerce_currency_symbol(),
						'final_price'         => sprintf(
							// Translators: 1: Free qty 2: Selected customer gets 3:span opening 4: span closing 5: Discount amount.
							__( '%s quantities of %s at a %s Final price %s of %s each', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_step1_summary_qty"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' ),
							wp_kses_post( '<span>' ),
							wp_kses_post( '</span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_s2_summary_discount_amount"></span>' )
						),
						'discount_free'       => sprintf(
							// Translators: 1: Free qty 2: Selected customer gets 3:span opening 4: span closing.
							__( '%s quantities of %s for %s Free %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_step1_summary_qty"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' ),
							wp_kses_post( '<span>' ),
							wp_kses_post( '</span>' ),
						...
						'discount_perc_fixed' => sprintf(
							// Translators: 1: Free qty 2: Selected customer gets 3:Discount amount 4: span closing.
							__( '%s quantities of %s with %s Discount %s each', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_step1_summary_qty"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_s2_summary_discount_amount"></span> <span>' ),
							wp_kses_post( '</span>' ),
						),
						'and_so_on'           => __( 'And so on', 'wt-smart-coupons-for-woocommerce-pro' ),
						'min_qty'             => __( 'Min quantity', 'wt-smart-coupons-for-woocommerce-pro' ),
						'max_qty'             => __( 'Max quantity', 'wt-smart-coupons-for-woocommerce-pro' ),
						'min_amount'          => __( 'Min amount', 'wt-smart-coupons-for-woocommerce-pro' ),
						'max_amount'          => __( 'Max amount', 'wt-smart-coupons-for-woocommerce-pro' ),
						'min_qty_each'        => __( 'Min quantity of each item', 'wt-smart-coupons-for-woocommerce-pro' ),
						'max_qty_each'        => __( 'Max quantity of each item', 'wt-smart-coupons-for-woocommerce-pro' ),
						'min_amount_each'     => __( 'Min amount of each item', 'wt-smart-coupons-for-woocommerce-pro' ),
						'max_amount_each'     => __( 'Max amount of each item', 'wt-smart-coupons-for-woocommerce-pro' ),
						'yes'                 => __( 'Yes', 'wt-smart-coupons-for-woocommerce-pro' ),
						'continue_confirm' => __( 'Are you sure you want to disable the old BOGO coupons?', 'wt-smart-coupons-for-woocommerce-pro' ),
						'success_copy' => sprintf(
							// Translators: 1: Success tick icon.
							__( "Code '{coupon_code}' copied %s", 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<img class="wbte_sc_bogo_code_copy" src="' . esc_url( "{$admin_img_path}success_icon.svg" ) . '" alt="' . esc_attr__( 'success', 'wt-smart-coupons-for-woocommerce-pro' ) . '" />' ),
						),
						'coupon_copy_tooltip' => __( 'Copy coupon code for backend', 'wt-smart-coupons-for-woocommerce-pro' ),
						'failed_copy' => __( 'Failed to copy:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'ctm_rls' => sprintf( __( 'Based on %s Custom %s rules', 'wt-smart-coupons-for-woocommerce-pro' ), '<span>', '</span>' ),
					),
					'individual_summary_text' => array(
						'spends_between_any'        => sprintf(
							...
							__( 'Customer %s Spends %s between %s {min} %s and %s {max} %s on any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'spends_between_selected'   => sprintf(
							...
							__( 'Customer %s Spends %s between %s {min} %s and %s {max} %s on %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'spends_atleast_any'        => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing.
							__( 'Customer %s Spends %s at least %s {min} %s on any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>'
						...
						'spends_atleast_selected'   => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing.
							__( 'Customer %s Spends %s at least %s {min} %s on %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'buys_between_any'          => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing.
							__( 'Customer %s Buys %s between %s {min} %s and %s {max} %s quantities of any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'buys_between_selected'     => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing 7: span opening 8: span closing.
							__( 'Customer %s Buys %s between %s {min} %s and %s {max} %s quantities of %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'buys_atleast_any'          => sprintf(
							...
							__( 'Customer %s Buys %s at least %s {min} %s quantities of any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>'
						...
						'buys_atleast_selected'     => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing.
							__( 'Customer %s Buys %s at least %s {min} %s quantities of %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'repeatedly_buys'           => sprintf(
							// Translators: 1: min qty 2: Selected customer gets 3: Customer gets qty .
							__( 'Buy %s , Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
						...
						'repeatedly_spends'         => sprintf(
							// Translators: 1: min spend 2: Selected customer gets 3: Customer gets qty .
							__( 'Spend %s , Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_repeatedly_min_sum">{buy_spend_val}</span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_repeatedly_free_count_sum">{repeatedly_free_count}</span>' )
						),
						'repeatedly_contains'       => sprintf(
							// Translators: 1: min qty 2: Selected customer gets 3: Customer gets qty .
							__( 'Cart contains %s , Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_repeatedly_min_sum">{buy_spend_val}</span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_repeatedly_free_count_sum">{repeatedly_free_count}</span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' )
						),
						'contains_between_any'      => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing.
							__( 'Cart contains between %s {min} %s and %s {max} %s quantities of any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>'
						),
						'contains_between_selected' => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing 5: span opening 6: span closing.
							__( 'Cart contains %s {min} %s and %s {max} %s quantities of %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>',
						...
						'contains_atleast_any'      => sprintf(
							// Translators: 1: span opening 2: span closing.
							__( 'Cart contains at least %s {min} %s quantities of any products', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>'
						),
						'contains_atleast_selected' => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing.
							__( 'Cart contains at least %s {min} %s quantities of %s Selected product(s) %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>',
							'</span>',
							'<span>',
							'</span>'
					...
					'urls'                    => array(
						'image_path' => WT_SMARTCOUPON_URL . 'admin/images/',
					),
					'ajaxurl'                 => admin_url( 'admin-ajax.php' ),
					'err_msgs'                => array(
						'gre_equal_1'       => __( 'Enter a number greater than or equal to 1', 'wt-smart-coupons-for-woocommerce-pro' ),
						'gre_equal_0'       => __( 'Enter a number greater than or equal to 0', 'wt-smart-coupons-for-woocommerce-pro' ),
						'gre_min'           => __( 'Enter a number greater than the minimum value.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'gre_0'             => __( 'Enter a value greater than 0.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_prod'    => __( 'Select at least one product', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_ex_prod' => __( 'Select at least one product to exclude.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_cat'     => __( 'Select at least one category', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_ex_cat'  => __( 'Select at least one category to exclude.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'range_spe_min'     => __( 'Enter a value at least equal to the previous maximum spend', 'wt-smart-coupons-for-woocommerce-pro' ),
						'range_spe_max'     => __( 'Enter a value at least equal to the minimum spend', 'wt-smart-coupons-for-woocommerce-pro' ),
						'range_qty_min'     => __( 'Enter a number greater than the previous maximum buy', 'wt-smart-coupons-for-woocommerce-pro' ),
						'range_qty_max'     => __( 'Enter a number at least equal to the minimum buy', 'wt-smart-coupons-for-woocommerce-pro' ),
						'no_camp_title'     => __( 'Enter a valid input', 'wt-smart-coupons-for-woocommerce-pro' ),
						'perc_less_eq_100'  => __( 'Enter a value not greater than 100', 'wt-smart-coupons-for-woocommerce-pro' ),
						'email_error'       => __( 'Enter a valid email address', 'wt-smart-coupons-for-woocommerce-pro' ),
						'coupon_code_error' => __( 'Enter a valid input (letters or numbers).', 'wt-smart-coupons-for-woocommerce-pro' ),
						'browser_leaving'   => __( 'Are you sure you want to leave this page? Your changes will not be saved.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'empty_schedule'    => __( 'Please select a schedule', 'wt-smart-coupons-for-woocommerce-pro' ),
						'gre_custmr_gets'   => __( 'Minimum quantity should be greater than the ‘Customer gets’ quantity', 'wt-smart-coupons-for-woocommerce-pro' ),
						'gre_equal_2'       => __( 'Enter a number greater than or equal to 2', 'wt-smart-coupons-for-woocommerce-pro' ),
						'valid_date'        => __( 'Enter a valid date', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_user_role'     => __( 'Select at least one user role', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_payment'     => __( 'Select at least one payment method', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_shipping'     => __( 'Please select at least one shipping method to use this restriction.', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_loc'     => __( 'Select at least one location', 'wt-smart-coupons-for-woocommerce-pro' ),
						'atleast_1_order'    => __( 'Select at least one order status', 'wt-smart-coupons-for-woocommerce-pro' ),
					),
					'short_summary_text'      => array(
						'add_conditions'   => __( 'Additional conditions:', 'wt-smart-coupons-for-woocommerce-pro' ),

						'limit_per_user'   => sprintf(
							// Translators: 1: Span opening 2: Span closing.
							__( 'Usage limit of %s {limit_per_user} %s per user.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>'
						),

						'limit_per_coupon' => sprintf(
							// Translators: 1: Span opening 2: Span closing.
							__( 'Usage limit of %s {limit_per_coupon} %s per offer.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>'
						),

						'qty'              => sprintf(
							// Translators: 1: Span opening 2: Span closing 3: Span opening 4: Span closing.
							__( 'Minimum %s {min_qty} %s and maximum %s {max_qty} %s quantity of any item.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>', '<span>', '</span>'
						),

						'qty_each'         => sprintf(
							// Translators: 1: Span opening 2: Span closing 3: Span opening 4: Span closing.
							__( 'Minimum %s {min_qty_each} %s and maximum %s {max_qty_each} %s quantity of each item.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>', '<span>', '</span>'
						),

						'min_qty'          => sprintf(
							// Translators: 1: Span opening 2: Span closing.
							__( 'Minimum %s {min_qty} %s quantity of any item.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>'
						),

						'min_qty_each'     => sprintf(
							// Translators: 1: Span opening 2: Span closing.
							__( 'Minimum %s {min_qty_each} %s quantity of each item.', 'wt-smart-coupons-for-woocommerce-pro' ),
							'<span>', '</span>'
						),

						'email'            => __( 'Allowed emails:', 'wt-smart-coupons-for-woocommerce-pro' ),

						'custom_buys'      => sprintf(
							// Translators: 1: Minimum qty 2: Maximum qty 3: Selected customer gets 4: Free qty.
							__( 'Buy %s to %s items, Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
						...
						'custom_spends'    => sprintf(
							// Translators: 1: Minimum spend 2: Maximum spend 3: Selected customer gets 4: Free qty.
							__( 'Spend %s to %s on items, Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_custom_min_sum"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_custom_max_sum"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_free_count_sum"></span>' )
						),
						'custom_contains'  => sprintf(
							// Translators: 1: Minimum qty 2: Maximum qty 3: Selected customer gets 4: Free qty.
							__( 'Cart contains %s to %s items, Get %s x %s', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_custom_min_sum"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_custom_max_sum"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_free_count_sum"></span>' ),
							wp_kses_post( '<span class="wbte_sc_bogo_edit_gets_selected"></span>' )
						...
						'repeatedly'       => sprintf(
							// Translators: 1: Repeatedly limit .
							__( ', up to %s times.', 'wt-smart-coupons-for-woocommerce-pro' ),
							wp_kses_post( '<span class="wbte_sc_bogo_repeatedly_sum"></span>' )
						),

						'purchase_first_time' => sprintf( __( 'Can be used on the %s First order %s', 'wt-smart-coupons-for-woocommerce-pro' ) , '<span>', '</span>' ),

						'nth_returning'          => sprintf( __( 'User must have placed %s {nth_order_cond} %s %s {nth_no_orders} %s orders and spent a minimum total of %s {nth_amount} %s', 'wt-smart-coupons-for-woocommerce-pro' ) , '<span>', '</span>', '<span>', '</span>', '<span>', '</span>' ),

						'pch_days'               => sprintf( __( ' within %s {nth_pch_days} %s days', 'wt-smart-coupons-for-woocommerce-pro' ) , '<span>', '</span>' ),

						'pch_date'               => sprintf( __( ' within %s {date_from} %s to %s {date_to} %s', 'wt-smart-coupons-for-woocommerce-pro' ) , '<span>', '</span>', '<span>', '</span>' ),

						'pch_order_sts'          => __( ' with order Status: ', 'wt-smart-coupons-for-woocommerce-pro' ),

						'pch_order_products'     => __( ' with Product purchased: ', 'wt-smart-coupons-for-woocommerce-pro' ),
						'user_role'              => __( 'Eligible user roles:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'payment_method'         => __( 'Eligible payment methods:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'shipping_method'        => __( 'Eligible shipping methods:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'billing_location'       => __( 'Eligible billing locations:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'shipping_location'      => __( 'Eligible shipping locations:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'ineligible_billing_location' => __( 'Ineligible billing locations:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'ineligible_shipping_location' => __( 'Ineligible shipping locations:', 'wt-smart-coupons-for-woocommerce-pro' ),
						'individual_only' => __( 'Offer cannot be used with other coupons', 'wt-smart-coupons-for-woocommerce-pro' ),
						'on_sale' => __( 'Offer applies to on-sale products only', 'wt-smart-coupons-for-woocommerce-pro' ),
						'on_non_sale' => __( 'Offer applies to regular products only', 'wt-smart-coupons-for-woocommerce-pro' ),
						'subtotal_eligible' => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing.
							__( 'Subtotal of eligible products between %s {min_subtotal} %s and %s {max_subtotal} %s', 'wt-smart-coupons-for-woocommerce-pro' ), 
							'<span>', '</span>', '<span>', '</span>'
						),
						'min_subtotal_eligible' => sprintf(
							// Translators: 1: span opening 2: span closing.
							__( 'Subtotal of eligible products at least %s {min_subtotal} %s', 'wt-smart-coupons-for-woocommerce-pro' ), 
							'<span>', '</span>'
						),
						'subtotal_entire' => sprintf(
							// Translators: 1: span opening 2: span closing 3: span opening 4: span closing.
							__( 'Subtotal of entire cart between %s {min_subtotal} %s and %s {max_subtotal} %s', 'wt-smart-coupons-for-woocommerce-pro' ), 
							'<span>', '</span>', '<span>', '</span>'
						),
						'min_subtotal_entire' => sprintf(
							// Translators: 1: span opening 2: span closing.
							__( 'Subtotal of entire cart at least %s {min_subtotal} %s', 'wt-smart-coupons-for-woocommerce-pro' ), 
							'<span>', '</span>'
						),
					),
	 ...
	 * @since 3.0.0
	 */
	private function change_old_bogo_status_to_draft() {
		global $wpdb;
	...
	/**
	 * Update old bogo coupons to draft when coupons are imported.
	 *
	 * @since 3.0.0
	 * @param int   $coupon_id          The coupon id.
	 * @param array $coupon_data        The coupon data.
	 * @param array $coupon_meta_data   The coupon meta data.
	 */
	public function make_old_bogo_draft_on_import( $coupon_id, $coupon_data, $coupon_meta_data ) {
		if ( self::is_new_bogo_activated() && 'wt_sc_bogo' === $coupon_meta_data['discount_type'] ) {
			...
			if ( wp_update_post(
				...
				$old_bogo_ids   = get_option( 'wbte_sc_old_bogo_ids', array() );
				$old_bogo_ids[] = $coupon_id;

				// Update old bogo ids option that when new bogo is deactivated, we can make them publish again.
				update_option( 'wbte_sc_old_bogo_ids', $old_bogo_ids );
			}
		}
	}
	...
	public function add_new_bogo() {
		...
		if ( isset( $_POST['data'] ) ) {
			...
			$predefined_settings = array(
				// Buy 1 item, get 1(same in cart) @ 50% off. Buy 2 items, get 2same in cart) @ 50% off — and so on.
				'default_1' => array(
					'wbte_sc_bogo_triggers_when' => 'wbte_sc_bogo_triggers_qty',
					'_wbte_sc_bogo_min_qty'      => 1,
					'wbte_sc_bogo_customer_gets' => 'same_product_in_the_cart',
				...
				// Buy 2 item, get 1(specific) for free. Buy 4 items, get 2(specific) for free — and so on.
				'default_2' => array(
					'wbte_sc_bogo_triggers_when' => 'wbte_sc_bogo_triggers_qty',
				...
				// Spend price 100 or above, get any product in the store for price 1.
				'default_4' => array(
					'wbte_sc_bogo_triggers_when'      => 'wbte_sc_bogo_triggers_subtotal',
					'_wbte_sc_bogo_min_amount'        => 100,
					'wbte_sc_bogo_customer_gets'      => 'any_product_from_store',
					'wbte_sc_bogo_customer_gets_with' => 'wbte_sc_bogo_customer_gets_with_final_price',
					'wbte_sc_bogo_customer_gets_final_price' => 1,
					'wbte_sc_bogo_type'               => 'wbte_sc_bogo_bxgx',
				),
				'custom'    => array(
					'wbte_sc_bogo_type' => $result['wbte_sc_bogo_type'],
				),
			);
	...
	public static function general_settings_submit() {
		...
		if ( isset( $_POST['data'] ) ) {
			...
			$return = array(
				'status' => true,
				'msg'    => __( 'General settings updated successfully!', 'wt-smart-coupons-for-woocommerce-pro' ),
			);
		}
		echo wp_json_encode( $return );
		die();
		...
		if ( isset( $_POST['data'] ) && isset( $_POST['data']['coupon_id'] ) && isset( $_POST['data']['is_checked'] ) ) {
			...
			if ( $coupon_id ) {
				...
				if ( $is_checked ) { // New status is publish.
					...
					$return['transition_to']       = __( 'Active', 'wt-smart-coupons-for-woocommerce-pro' );
					$return['transition_to_class'] = 'wbte_sc_label-success';
					$return['msg']                 = __( 'BOGO promotion enabled successfully!', 'wt-smart-coupons-for-woocommerce-pro' );
				} else {
					wp_update_post(
						array(
							'ID'          => $coupon_id,
					...
					$return['transition_to']       = __( 'Inactive', 'wt-smart-coupons-for-woocommerce-pro' );
					$return['transition_to_class'] = 'wbte_sc_label-warning';
					$return['msg']                 = __( 'BOGO promotion disabled successfully!', 'wt-smart-coupons-for-woocommerce-pro' );
				}
				$coupon->save();
				$return['status'] = true;
			}
	...
	public function bogo_coupon_save() {
		...
		if ( isset( $_POST['data'] ) ) {
			...
			if ( '' === $coupon_code ) {
				$return['msg'] = __( 'Enter a valid coupon code', 'wt-smart-coupons-for-woocommerce-pro' );
				echo wp_json_encode( $return );
				die();
			}
			if ( $old_coupon_code !== $coupon_code && post_exists( $coupon_code ) ) {
				$return['msg'] = __( 'Coupon code already exists', 'wt-smart-coupons-for-woocommerce-pro' );
				echo wp_json_encode( $return );
				die();
			}
			...
			do_action( 'wt_sc_before_bogo_coupon_save', $post_id, $result );

			$return    = array(
				'status'   => true,
				'msg'      => __( 'Your BOGO offer saved successfully!', 'wt-smart-coupons-for-woocommerce-pro' ),
				'bogo_sts' => 'draft',
			);
			if ( 'wbte_sc_bogo_save_and_activate' === $result['clicked_button'] || 'publish' === $result['_wbte_sc_bogo_selected_sts'] ) {
				...
				$return['msg']            = __( 'Your BOGO offer is now live!', 'wt-smart-coupons-for-woocommerce-pro' );
			}
			wp_update_post( $post_data );
			$return['status'] = true;
		}
	...
	public static function bogo_coupon_delete_on_listing() {
		...
		if ( isset( $_POST['coupon_id'] ) ) {
			...
			$return['status'] = true;
			$return['msg']    = __( 'BOGO promotion removed successfully!', 'wt-smart-coupons-for-woocommerce-pro' );
		}
		echo wp_json_encode( $return );
		die();
	}
	...
	public static function bogo_coupon_multiple_enable() {
		...
		if ( isset( $_POST['coupon_ids'] ) ) {
			...
			foreach ( $_coupon_ids as $coupon_id ) {
				...
				if ( Wt_Smart_Coupon_Lifespan::get_instance()->is_coupon_expired( $coupon )
					|| 'draft' !== $coupon->get_status()
					|| get_post_meta( $coupon_id, Wt_Smart_Coupon_Admin::$master_coupon_meta_key, true )
				) {
					continue;
				}
			...
			$return = array(
				'status'              => true,
				'transition_to'       => __( 'Active', 'wt-smart-coupons-for-woocommerce-pro' ),
				'transition_to_class' => 'wbte_sc_label-success',
				'changed_arrs'        => $changed_arrs,
				'msg'                 => __( 'BOGO promotions enabled successfully!', 'wt-smart-coupons-for-woocommerce-pro' ),
			);
		}
		echo wp_json_encode( $return );
		die();
	...
	public static function bogo_coupon_multiple_disable() {
		...
		if ( isset( $_POST['coupon_ids'] ) ) {
			...
			$return = array(
				'status'              => true,
				'transition_to'       => __( 'Inactive', 'wt-smart-coupons-for-woocommerce-pro' ),
				'transition_to_class' => 'wbte_sc_label-warning',
				'changed_arrs'        => $changed_arrs,
				'msg'                 => __( 'BOGO promotions disabled successfully!', 'wt-smart-coupons-for-woocommerce-pro' ),
			);
		}
		echo wp_json_encode( $return );
		die();
	...
	public static function bogo_coupon_single_duplicate() {
		...
		if ( isset( $_POST['coupon_id'] ) ) {
			...
			$duplicate_coupon_id = Wt_Smart_Coupon_Admin::clone_coupon( $old_coupon_id );
	...
	public function review_request( $footer_text ) {
		if ( isset( $_GET['page'] ) && sanitize_text_field( wp_unslash( $_GET['page'] ) ) === self::$bogo_page_name && ! isset( $_GET['wbte_bogo_id'] ) ) {
			...
			$has_basic_plugin = false;
			$plugin_slug = 'wt-smart-coupons-for-woocommerce/wt-smart-coupon.php';
			$installed_plugins = get_plugins();
			foreach ( $installed_plugins as $plugin_path => $plugin_info ) {
				if ( false !== strpos( $plugin_path, $plugin_slug ) ) {
					$has_basic_plugin = true; 
					break;
				}
			}

			$review_url = $has_basic_plugin ? 'https://wordpress.org/support/plugin/wt-smart-coupons-for-woocommerce/reviews?rate=5#new-post' : 'https://www.webtoffee.com/testimonials/?product_id=85057#submit-your-review';
	...
	/**
	 * Display free product discount detail in admin order edit page.
	 *
	 * @since 3.0.0
		...
		foreach ( $order_items as $order_item_id => $order_item ) {
			...
			if ( $giveaway_info ) {
				...
				<tr>
					...
					<td width="1%"></td>
					<td class="total"><?php echo wp_kses_post( $giveaway_info ); ?></td>
				</tr>
				<?php
			}
		}
