...
if(!class_exists ('Wt_Smart_Coupon_Signup_Coupon')) /* common module class not found so return */
{
    return; 
}

class Wt_Smart_Coupon_Signup_Coupon_Admin extends Wt_Smart_Coupon_Signup_Coupon
{
    ...
    public static function get_instance()
    {
        ...
        {
            self::$instance=new Wt_Smart_Coupon_Signup_Coupon_Admin();
        }
    ...
    public function add_admin_pages($menus)
    {
        $menus[]=array(
            'submenu',
            WT_SC_PLUGIN_NAME,
            __('Signup coupons','wt-smart-coupons-for-woocommerce-pro'),
            __('Signup coupons','wt-smart-coupons-for-woocommerce-pro'),
            'manage_woocommerce',
            $this->module_id,
            array($this, 'signup_coupon_page_content')
        );
        return $menus;
    }

    public function signup_coupon_page_content()
    {
    ...
    { 
        return $base_id === $this->module_id ? 'wt_signup_master_coupon' : $option_name;
    }
...
Wt_Smart_Coupon_Signup_Coupon_Admin::get_instance();