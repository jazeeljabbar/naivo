(function( $ ) {
	...
	var wt_sc_coupon_usage_restriction=
	{
		Set:function()
		{
			...
			/** 
			 *	Replace exclude sale item help text 
			 * 	
			 * 	@since 2.0.7
			 */
			$('p.exclude_sale_items_field span.description').html(wt_sc_coupon_restriction_params.msgs.exclude_sale_item_help_text);
			 ...
			 * 	@since 2.0.8
			 */
			$('p.form-field').has('[name="exclude_product_categories[]"]').after($('fieldset.wt_sc_product_tags_fieldset'));
			$('.wt_sc_product_tags_fieldset .select2-container .select2-selection--multiple').css({'min-height':'40px'});
			 ...
			 * 	@since 2.0.8
			 */
			 $('p.form-field').has('[name="exclude_product_categories[]"]').after($('fieldset.wt_sc_product_attributes_fieldset'));
			 $('.wt_sc_product_attributes_fieldset .select2-container .select2-selection--multiple').css({'min-height':'40px'});
		},
