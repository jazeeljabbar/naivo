...
class Wt_Smart_Coupon_Licence_Manager_Edd
{
	...
	public static function get_instance()
    {
        if(!self::$instance)
        {
            self::$instance=new Wt_Smart_Coupon_Licence_Manager_Edd();
        }
	...
	*/
	public function check_status($licence_data, $response_arr) {
	    ...
	    if ( ! empty( $response_arr['success'] ) ) {
	        if ( true === $response_arr['success'] && !empty( $response_arr['license'] ) ) {
	            $new_status = ( $response_arr['license'] === 'valid' ) ? 'active' : 'inactive';
	        } elseif ( isset( $response_arr['license'] ) && $response_arr['license'] !== 'valid' ) {
	            $new_status = 'inactive';
	        }
	    }
	    return $new_status;
