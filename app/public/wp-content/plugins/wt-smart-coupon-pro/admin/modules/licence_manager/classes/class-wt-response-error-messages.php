...
class Wt_Sc_licence_manager_error_messages
{
	...
	public function expired_license_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %s has expired. You can reactivate or purchase a license key from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function on_hold_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is on-hold. You can reactivate the subscription from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function cancelled_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been cancelled. You can renew the subscription from your account %s dashboard %s. A new license key will be emailed to you after your order has been completed.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function expired_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has expired. You can reactivate the subscription from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function suspended_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been suspended. You can reactivate the subscription from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function pending_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is still pending. You can check on the status of the subscription from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function no_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A subscription for %s could not be found. You can purchase a subscription from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function download_revoked_error_notice( $message ){ 
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'Download permission for %s has been revoked possibly due to a license key or subscription expiring. You can reactivate or purchase a license key from your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
	...
	public function no_activation_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( '%s has not been activated. Go to the plugin %s and enter the license key and license email to activate %s.', 'wt-smart-coupons-for-woocommerce-pro') . '</p></div>', $this->product_display_name, '<a href="'.$this->plugin_settings_url.'" target="_blank">', '</a>', $this->product_display_name ) ;
	...
	public function switched_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %s, so you will need to enter your new API License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account %s dashboard %s.', 'wt-smart-coupons-for-woocommerce-pro').'</p></div>', $this->product_display_name, '<a href="'.$this->my_account_url.'" target="_blank">', '</a>' ) ;
