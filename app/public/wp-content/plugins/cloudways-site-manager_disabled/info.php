...
if (!class_exists('CWMGRInfo')) :
	class CWMGRInfo {
		public $settings;
		public $config;
		public $plugname = 'cloudways_wp_manager';
		public $brandname = 'Cloudways Site Manager';
		public $badgeinfo = 'cwmgrbadge';
		...
		public $plug_redirect = 'cwmgrredirect';
		public $logo = '/assets/img/cloudways-logo.png';
		public $brand_icon = '/assets/img/favicon.ico';
		public $services_option_name = 'cwmconfig';
		public $author = 'Cloudways';
		public $title = 'Cloudways Site Manager';
		...
		public function hasValidDBVersion() {
			return CWMGRInfo::DB_VERSION === $this->getCurrentDBVersion();
		}
		...
		public function getDefaultSecret() {
			require_once dirname( __FILE__ ) . '/recover.php';
			$bvsiteinfo = new CWMGRWPSiteInfo();
			return CWMGRRecover::defaultSecret($this->settings);
		}
		...
		public static function getRequestID() {
			if (!defined("CWMGR_REQUEST_ID")) {
				define("CWMGR_REQUEST_ID", uniqid(mt_rand())); // phpcs:ignore WordPress.WP.AlternativeFunctions.rand_mt_rand
			}
			return CWMGR_REQUEST_ID;
		}
